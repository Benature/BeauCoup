...
control SwitchIngress(
        ...
        action calc_hash_1_a(){
            ig_md.h_1 = hash_1.get({  16w50583,7w0,  ig_intr_md.ingress_mac_tstamp   });    
        }
        ...
        action calc_hash_2_a(){
            ig_md.h_2 = hash_2.get({  16w28221,16w0,  hdr.ipv4.dst_addr   });    
        }
        ...
        action calc_hash_3_a(){
            ig_md.h_3 = hash_3.get({  16w14875,12w0,  hdr.ipv4.dst_addr,hdr.tcp.dst_port   });    
        }
        ...
        action calc_hash_4_a(){
            ig_md.h_4 = hash_4.get({  16w49277,5w0,  hdr.ipv4.dst_addr,hdr.udp.dst_port   });    
        }
        ...
        action calc_hash_5_a(){
            ig_md.h_5 = hash_5.get({  16w22112,9w0,  hdr.ipv4.src_addr   });    
        }
        ...
        action calc_hash_6_a(){
            ig_md.h_6 = hash_6.get({  16w41913,16w0,  hdr.ipv4.src_addr,hdr.tcp.src_port   });    
        }
        ...
        action calc_hash_7_a(){
            ig_md.h_7 = hash_7.get({  16w45746,11w0,  hdr.ipv4.src_addr,hdr.udp.src_port   });    
        }
        ...
        action calc_hash_8_a(){
            ig_md.h_8 = hash_8.get({  16w28024,13w0,  hdr.tcp.dst_port   });    
        }
        ...
        action calc_hash_9_a(){
            ig_md.h_9 = hash_9.get({  16w53126,8w0,  hdr.tcp.src_port   });    
        }
        ...
        action calc_hash_10_a(){
            ig_md.h_10 = hash_10.get({  16w33743,2w0,  hdr.udp.dst_port   });    
        }
        ...
        action calc_hash_11_a(){
            ig_md.h_11 = hash_11.get({  16w55341,4w0,  hdr.udp.src_port   });    
        }
